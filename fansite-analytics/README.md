...
===================
My Note: Please be aware that I had to remove the following two lines from the given log.txt and created logCleaned.txt
which is the base for my program.  Due to the lack of time I did not get a chance to handle these special characters.
My goal is to show a working program where everything works fine once you remove these two lines.

pipe3.nyc.pipeline.com - - [02/Jul/1995:22:24:41 -0400] "GET /shuttle/countdown/dy €?shuttle%20tracking HTTP/1.0" 404 -
202.251.172.60 - - [14/Jul/1995:04:10:23 -0400] "GET /shuttle/missions/sts-65/mission-sts-65.htmlhþ§Š ’žŽ‡||(­ HTTP/1.0" 404 -
